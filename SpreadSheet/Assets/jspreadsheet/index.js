    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            text:{
                ...
                insertANewColumnBefore: 'Вставить новый столбец слева',
                insertANewColumnAfter: 'Вставить новый столбец справа',
                deleteSelectedColumns: 'Delete selected columns',
                renameThisColumn: 'Rename this column',
                orderAscending: 'Order ascending',
                orderDescending: 'Order descending',
                insertANewRowBefore: 'Вставить новую строку выше',
                insertANewRowAfter: 'Вставить новую строку ниже',
        ...
        obj.setValueFromCoords = function(x, y, value, force) {
            var records = [];
            records.push(obj.updateCellCustom(x, y, value, force));
         ...
         * @return void
         */
        obj.updateCellCustom = function(x, y, value, force) {
            // Changing value depending on the column type
            if (obj.records[y][x].classList.contains('readonly') == true && ! force) {
                // Do nothing
                var record = {
        ...
        obj.paste = function(x, y, data) {
            ...
            if (x != null && y != null && data) {
                ...
                while (row = data[j]) {
                    ...
                    while (row[i] != null) {
                        let curCell = obj.records[rowIndex][colIndex];
                        if(curCell.classList.contains('readonly')){
                            return false;
                        }

                        // Update and keep history
                        var record = obj.updateCellCustom(colIndex, rowIndex, row[i]);
                        // Keep history
                        records.push(record);
                        // Update all formulas in the chain
                ...
                // Paste event
                obj.dispatch('onpaste', el, data, x, y);
